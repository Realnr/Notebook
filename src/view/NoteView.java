...
public class NoteView {
    ...
    public void createButtons(){
        ...
        invertToDo.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(userSelection.getSelectedItem()!=null) {
                    String tempUsername = userSelection.getName();
                    int tempIndex = userSelection.getSelectedIndex();
                    User tempUser = userController.getUserByUsername(tempUsername);
                    noteController.invertToDoNote(tempUser, tempIndex);
                }
            }
        });
        ...
        removeNote.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(userSelection.getSelectedItem()!=null) {
                    String tempUsername = userSelection.getName();
                    int tempIndex = userSelection.getSelectedIndex();
                    userController.deleteNoteFromUser(tempUsername,tempIndex);
                }
            }
        });
    }
